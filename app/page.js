...
export default function Home() {
  return (
    <div className="bg-background dark:bg-background-dark min-h-screen text-gray-900 dark:text-gray-100">
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-foreground text-lg md:text-xl max-w-md">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="border-emerald-700/30 hover:bg-emerald-700 text-white"
                >
